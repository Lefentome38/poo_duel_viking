...
export class Viking extends Parramettre_metier {
    ...
    info_viking_class(){
        console.log(`class ${this.nom_class}: ${this.name_bonus} ${this.sante_bonus}hp, équipement de type ${this.equipement_bonus.type} '${this.equipement_bonus.name_equipement}' de résistence ${this.equipement_bonus.defense_equipement}, chance critique "+${this.critique_bonus}%"`);
    }
}
