...
export class Chevalier extends Parramettre_metier{
    ...
    info_chevalier_class(){
        console.log(`${this.name_bonus} ${this.sante_bonus}hp, équipement de type ${this.equipement_bonus.type} '${this.equipement_bonus.name_equipement}' de force ${this.equipement_bonus.force_equipement}, chance critique "+${this.critique_bonus}%"`);
    }
}
