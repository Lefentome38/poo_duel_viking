import { Viking,Viking1 } from "./type_perso/vikings";
...
import { Personnage,combatant1,combatant3 } from "./type_perso/personnage";

const commbat1 = new Commbat(combatant1,combatant3)
